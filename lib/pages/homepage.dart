...
request.fields['lastName'] = 'efg';*/
  ...
  String findGrade(int sumpixs) {
    if(sumpixs > 60000){
      ...
      datasize = 'รายละเอียด : จะมีขนาดความกว้าง\nประมาณ 4-5 เซนติเมตร';
      return "S";
    }
    else if(sumpixs >= 15001 && sumpixs <= 20000) {
      datasize = 'รายละเอียด : จะมีขนาดความกว้าง\nประมาณ 6-8 เซนติเมตร';
      return "M";
    }
    else if(sumpixs >= 20001 && sumpixs <= 30000){
      datasize = 'รายละเอียด : จะมีขนาดความกว้าง\nประมาณ 8-9 เซนติเมตร';
      return "L";
    }
    else if(sumpixs > 30000) {
      datasize = 'รายละเอียด : จะมีขนาดความกว้าง\nประมาณ 10 เซนติเมตรขึ้นไป';
      return "XL";
    }
    ...
    }else if (sumpixs >=15600 && sumpixs<16200){

      return "2";

    }else if (sumpixs < 15600){
